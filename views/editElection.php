            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <p>Enter the ID of the election you want to edit.</p>
                        <form action="../controllers/editElectionController.php" method="POST">

                            <div class="col-md-12">
                               <input class="form-control" type="number" name="election_id" placeholder="Election ID" required>
                            </div><br>
